<%-- 
    Document   : detalle_nomina
    Created on : Jan 17, 2019, 11:17:47 AM
    Author     : Carlos
--%>
...
<html>
    ...
    <body>
        ...
        <section class="container white">
            ...
            <h5>Detalle de Nómina:</h5>
            <br/>
            <table class="bordered highlight">
                <tr>
                    <th bgcolor="#147AB9" class="white-text">Id</th>
                    <th bgcolor="#147AB9" class="white-text">Tipo de registro</th>
                    <th bgcolor="#147AB9" class="white-text">Cedula</th>
                    <th bgcolor="#147AB9" class="white-text">No. de cuenta</th>
                    <th bgcolor="#147AB9" class="white-text">Sueldo Neto</th>
                    <th bgcolor="#147AB9" class="white-text">Fecha de nomina</th>
                    <th bgcolor="#147AB9" class="white-text">RNC empresa</th>
                </tr>

                <%

                    DetalleNomina dnomina = new DetalleNomina();

                    ResultSet rs = null;
                    rs = dnomina.obtenerDatos();
